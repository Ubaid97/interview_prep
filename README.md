...
## DevOps
### What is DevOps -
DevOps is a set of practices that works to automate and integrate the processes between software development and IT teams, so they can build, test, and release software faster and more reliably. Traditionally the development team and operations team work seperately, which can lead to issues sue to a lack of communication, or lack of proper avenues for collaboration. The development team works on the product in the development environment, whilst the operations team makes sure things run smoothly in the production environment, and given that the two environments are different, it's important that there's good communication between the two teams because the dev team needs feedback from the product's performance in the production environment, and the operations team need to have a good understanding on the developed product. DevOps, by removing the barriers between the two ensures greater collaboration, and as a result, less problems arising as a result of a lack of communication or understanding across development and operations. By working closer together and sharing responsibilities, there's greater trust between members working in development and operations, and they're also able to release faster by automating the pipeline between the two

### Why DevOps - 
Devops is a relatively new approach to development and operations, making it an exciting field with a wide scope for innovation and creativity. A good DevOps engineer needs to have sound technical skills across a variety of different domains, from development and testing to operations, but also good soft skills for effective collaboration. This is exactly the kind of opportunity I'm looking for, an opportunity for me to apply my technical skills in a creative environment and also interact personally with a wide variety of colleagues and members from various backgrounds working together throughout the lifecycle of a product. In addition to this, the DevOps market is expanding at an ever-increasing rate making it the ideal place for me to ply my trade
